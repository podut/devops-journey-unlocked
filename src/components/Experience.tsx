  ...
  const gitlabProjects = [
    {
      ...
      challenge: "Manual infrastructure provisioning was slow and error-prone, taking hours per environment.",
      solution: "Built a fully automated IaC pipeline with Terraform modules and Ansible playbooks, integrated with CI/CD.",
      result: "Reduced provisioning time from 4 hours to 15 minutes. Zero configuration drift across environments.",
      stars: 5,
    ...
    },
    {
      ...
      challenge: "Kubernetes clusters were manually configured, leading to inconsistencies between staging and production.",
      solution: "Implemented Terraform-managed EKS with Helm charts for standardized deployments across all environments.",
      result: "100% environment parity. Cluster spin-up automated in under 20 minutes.",
      stars: 0,
    ...
    },
    {
      ...
      challenge: "Security testing was done manually and inconsistently, missing critical vulnerabilities.",
      solution: "Built an automated DevSecOps pipeline with SAST, DAST, and dependency scanning integrated into CI/CD.",
      result: "Identified 15+ vulnerabilities automatically per release. Reduced security review time by 70%.",
      stars: 9,
    ...
    },
    {
      ...
      challenge: "Complex microservices architecture with no observability, making debugging production issues difficult.",
      solution: "Deployed on Kubernetes with Istio service mesh, Prometheus monitoring, and Grafana dashboards.",
      result: "Full observability across 11 microservices. Mean time to detect issues reduced by 80%.",
      stars: 0,
    ...
    },
    {
      ...
      challenge: "Deployments required manual kubectl commands, leading to inconsistent releases and rollback difficulties.",
      solution: "Implemented GitOps workflow with ArgoCD for declarative, git-driven deployments with automatic sync.",
      result: "Deployment frequency increased 3x. Rollbacks now take seconds instead of minutes.",
      stars: 2,
            ...
            {gitlabProjects.map((project, index) => (
              ...
              >
                ...
                <CardContent className="relative z-10 pt-0">
                  <p className="text-muted-foreground mb-4 text-lg leading-relaxed group-hover:text-foreground/80 transition-colors duration-300">
                    {project.description}
                  </p>
                  ...
                  <div className="mb-6 space-y-2 text-sm">
                    <div className="flex items-start gap-2">
                      <span className="font-semibold text-red-400 shrink-0">Challenge:</span>
